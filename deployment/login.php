...
if ($_POST) {
    ...
    if (!empty($username) && !empty($password)) {
        ...
        $query = "SELECT id, username, password, nama_lengkap, kelas FROM users WHERE username = :username";
        ...
        if ($stmt->rowCount() > 0) {
            ...
            // Verifikasi password dengan password_verify untuk hash modern atau MD5 untuk data lama
