...
-- Dibuat berdasarkan gambar referensi yang diberikan

CREATE DATABASE IF NOT EXISTS akm_online_test;
USE akm_online_test;
...
INSERT INTO questions (test_id, nomor_soal, pertanyaan, gambar, pilihan_a, pilihan_b, pilihan_c, pilihan_d, jawaban_benar) VALUES 
...
(1, 4, 'Dari konteks cerita, aktivitas nenek kemungkinan besar adalah...', NULL, 'Membersihkan rumah', 'Merawat kesehatan', 'Memasak makanan', 'Mencuci pakaian', 'B'),
(1, 5, 'Kata "tetes-tetes" dalam kalimat menunjukkan bahwa cairan tersebut...', NULL, 'Sangat banyak jumlahnya', 'Diberikan dalam jumlah sedikit dan hati-hati', 'Tidak sengaja tumpah', 'Sudah kering dan mengeras', 'B'),
(1, 6, 'Jika 3x + 5 = 20, maka nilai x adalah...', NULL, '3', '5', '7', '15', 'B'),
(1, 7, 'Sebuah persegi panjang memiliki panjang 12 cm dan lebar 8 cm. Luas persegi panjang tersebut adalah...', NULL, '20 cm²', '40 cm²', '96 cm²', '160 cm²', 'C'),
(1, 8, 'Hasil dari 15% dari 200 adalah...', NULL, '15', '20', '30', '35', 'C'),
(1, 9, 'Jika sebuah segitiga memiliki alas 10 cm dan tinggi 6 cm, maka luasnya adalah...', NULL, '16 cm²', '30 cm²', '60 cm²', '120 cm²', 'B'),
(1, 10, 'Manakah dari bilangan berikut yang merupakan bilangan prima?', NULL, '15', '21', '23', '27', 'C'),
(1, 11, 'Rata-rata dari angka 8, 12, 15, dan 9 adalah...', NULL, '10', '11', '12', '13', 'B');