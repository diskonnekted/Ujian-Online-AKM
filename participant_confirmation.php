...
if ($_POST) {
    ...
    // Validasi token kesiapan (contoh: harus "SIAP")
    else if (strtoupper($token_kesiapan) !== "SIAP") {
        $error = "Token kesiapan harus diisi dengan 'SIAP'!";
    }
...
<body>
    ...
    <div class="main-container">
        <div class="search-container">
            <input type="text" class="search-input" placeholder="Token : JZYWFW" value="JZYWFW" readonly>
            <button class="search-btn">Refresh</button>
        </div>
        ...
        <div class="confirmation-container">
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" name="token_kesiapan" placeholder="Ketik 'SIAP' untuk melanjutkan" required>
                    <small style="color: #718096; font-size: 12px; margin-top: 5px; display: block;">* Ketik kata "SIAP" untuk mengkonfirmasi kesiapan mengikuti ujian</small>
                </div>
